...
export default function ChatWithAI() {
  ...
  return (
    <div style={{ minHeight:'100vh', background:'hsl(260,87%,3%)', display:'flex', flexDirection:'column' }}>
      ...
      <div style={{ flex:1, display:'flex', overflow:'hidden', height:'calc(100vh - 64px)', marginTop:64 }}>
        {/* Sidebar */}
        <div style={{
        ...
        <div style={{ flex:1, display:'flex', flexDirection:'column', overflow:'hidden' }}>
          ...
          <div style={{ padding:'12px 20px', borderBottom:'1px solid rgba(255,255,255,0.06)', display:'flex', alignItems:'center', gap:12 }}>
            ...
            <div style={{ width:36, height:36, borderRadius:'50%', background:'linear-gradient(135deg,#7c3aed,#4f46e5)', display:'flex', alignItems:'center', justifyContent:'center' }}>
              <Bot size={18} color="#fff" />
            </div>
            <div>
              <div style={{ fontWeight:600, color:'hsl(40,6%,95%)', fontSize:14 }}>AI Universe Assistant</div>
          ...
          <div style={{ flex:1, overflowY:'auto', padding:'24px 20px', display:'flex', flexDirection:'column', gap:20 }}>
            {messages.length === 0 && (
              <div style={{ flex:1, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', textAlign:'center', padding:'40px 20px' }}>
                <div style={{ width:64, height:64, borderRadius:20, background:'linear-gradient(135deg,rgba(124,58,237,0.2),rgba(79,70,229,0.2))', border:'1px solid rgba(124,58,237,0.2)', display:'flex', alignItems:'center', justifyContent:'center', marginBottom:20 }}>
          ...
          <div style={{ padding:'12px 20px', borderTop:'1px solid rgba(255,255,255,0.06)' }}>
            <div className="glass-card" style={{ borderRadius:14, padding:'10px 10px 10px 18px', display:'flex', alignItems:'center', gap:10, border:'1px solid rgba(124,58,237,0.2)' }}>
              <textarea
                value={input}
